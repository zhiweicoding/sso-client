...
public class SsoClientController {
	...
	@RequestMapping("/")
	public String index() {
		String str = "<h2>Sa-Token SSO-Client client</h2>" +
					"<p>page is login :" + StpUtil.isLogin() + "</p>" +
					"<p><a href=\"javascript:location.href='/sso/login?back=' + encodeURIComponent(location.href);\">login</a>" +
					" <a href='/sso/logout?back=self'>sign out</a></p>";
		return str;
	}
	...
	public Object myFollowList() {
		// 组织url，加上签名参数
		String url = SaSsoUtil.addSignParams("http://localhost:9000/sso/getFollowList", StpUtil.getLoginId());
